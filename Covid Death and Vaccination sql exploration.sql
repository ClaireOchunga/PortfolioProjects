-- Exploration on the data layout
SELECT *
FROM PortfolioProject..CovidDeaths
ORDER BY 3,4


-- -- Exploration on the locations available in the data
SELECT 
DISTINCT location, continent
FROM PortfolioProject..CovidVaccination
WHERE continent IS NOT NULL
ORDER BY continent 


-- Selection of data list I am going to use
SELECT location, date, total_cases, new_cases, total_deaths, population
FROM PortfolioProject..CovidDeaths
order by 1,2


-- Looking at Total cases vs Total Deaths, which shows the likelihood of dying if you contract COVID in your country
SELECT 
    location, 
    date, 
    total_cases, 
...
FROM PortfolioProject..CovidDeaths
 ...
 --the number of vaccinations throughout the days
 SELECT 
    dea.continent, dea.location, dea.date, dea.population, vac.new_vaccinations,
